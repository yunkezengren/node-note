...
def init_props():
    ...
    Node.note_txt_bg_width   = IntProperty(name="背景宽度", default=prefs.default_txt_bg_width, min=1, max=2000)
    Node.note_img_width      = IntProperty(name="图像宽度", default=prefs.default_img_width, min=10, max=2000)
