...
class NodeMemoAddonPreferences(AddonPreferences):
    ...
    show_select_txt     : BoolProperty(name="显示选中文本", default=True, update=tag_redraw, description="显示选中所有节点的文本笔记")
    show_select_img     : BoolProperty(name="显示选中图片", default=True, update=tag_redraw, description="显示选中所有节点的图片笔记")
    show_select_seq     : BoolProperty(name="显示选中序号", default=True, update=tag_redraw, description="显示选中所有节点的序号笔记")
